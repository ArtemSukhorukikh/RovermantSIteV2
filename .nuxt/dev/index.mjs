...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://G:/ProgramsSiteV2/node_modules/h3/dist/index.mjs';
import { Prisma, PrismaClient } from 'file://G:/ProgramsSiteV2/node_modules/@prisma/client/default.js';
import { compareSync, genSaltSync, hashSync } from 'file://G:/ProgramsSiteV2/node_modules/bcrypt-ts/dist/node.mjs';
import * as jose from 'file://G:/ProgramsSiteV2/node_modules/jose/dist/node/esm/index.js';
import { mkdir, writeFile } from 'fs/promises';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://G:/ProgramsSiteV2/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://G:/ProgramsSiteV2/node_modules/devalue/index.js';
import destr from 'file://G:/ProgramsSiteV2/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://G:/ProgramsSiteV2/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://G:/ProgramsSiteV2/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://G:/ProgramsSiteV2/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://G:/ProgramsSiteV2/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://G:/ProgramsSiteV2/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://G:/ProgramsSiteV2/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://G:/ProgramsSiteV2/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://G:/ProgramsSiteV2/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://G:/ProgramsSiteV2/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://G:/ProgramsSiteV2/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://G:/ProgramsSiteV2/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://G:/ProgramsSiteV2/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://G:/ProgramsSiteV2/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://G:/ProgramsSiteV2/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://G:/ProgramsSiteV2/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file://G:/ProgramsSiteV2/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://G:/ProgramsSiteV2/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://G:/ProgramsSiteV2/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"G:/ProgramsSiteV2/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"G:\\ProgramsSiteV2","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"G:\\ProgramsSiteV2\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"G:\\ProgramsSiteV2\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"G:\\ProgramsSiteV2\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"G:\\ProgramsSiteV2\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _ZCw5PMI0QD = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "G:/ProgramsSiteV2";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _l5jJe1Rvh1 = (nitroApp) => {
...
const _9eXJGZXeCE = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _lazy_uTsinr = () => Promise.resolve().then(function () { return combineConditionals_get$1; });
const _lazy_bhVGwA = () => Promise.resolve().then(function () { return _id__get$b; });
const _lazy_Yyd4A4 = () => Promise.resolve().then(function () { return addCondition_post$1; });
const _lazy_ALzjDB = () => Promise.resolve().then(function () { return addExtractData_post$1; });
const _lazy_J5NhbO = () => Promise.resolve().then(function () { return all_get$3; });
const _lazy_jWkIj3 = () => Promise.resolve().then(function () { return create_post$3; });
const _lazy_2oTTEJ = () => Promise.resolve().then(function () { return delete_post$3; });
const _lazy_ALn4zC = () => Promise.resolve().then(function () { return update_post$3; });
const _lazy_fCK1to = () => Promise.resolve().then(function () { return _id__get$9; });
const _lazy_6gpEKf = () => Promise.resolve().then(function () { return _id__get$7; });
const _lazy_PYXFHb = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_BVWktj = () => Promise.resolve().then(function () { return register_post$1; });
const _lazy_6TfMNF = () => Promise.resolve().then(function () { return _id__get$5; });
const _lazy_8fnUuk = () => Promise.resolve().then(function () { return addConditions_post$1; });
const _lazy_9c1ASD = () => Promise.resolve().then(function () { return all_get$1; });
const _lazy_m33m01 = () => Promise.resolve().then(function () { return create_post$1; });
const _lazy_t3E54W = () => Promise.resolve().then(function () { return delete_post$1; });
const _lazy_6AqCoD = () => Promise.resolve().then(function () { return update_post$1; });
const _lazy_uggxjB = () => Promise.resolve().then(function () { return _id__get$3; });
const _lazy_AAYEoK = () => Promise.resolve().then(function () { return _id__get$1; });
const _lazy_5nVHhz = () => Promise.resolve().then(function () { return edit_post$1; });
const _lazy_P0jYr6 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/combineConditionals', handler: _lazy_uTsinr, lazy: true, middleware: false, method: "get" },
  { route: '/api/company/:id', handler: _lazy_bhVGwA, lazy: true, middleware: false, method: "get" },
  { route: '/api/company/addCondition', handler: _lazy_Yyd4A4, lazy: true, middleware: false, method: "post" },
  { route: '/api/company/addExtractData', handler: _lazy_ALzjDB, lazy: true, middleware: false, method: "post" },
  { route: '/api/company/all', handler: _lazy_J5NhbO, lazy: true, middleware: false, method: "get" },
  { route: '/api/company/create', handler: _lazy_jWkIj3, lazy: true, middleware: false, method: "post" },
  { route: '/api/company/delete', handler: _lazy_2oTTEJ, lazy: true, middleware: false, method: "post" },
  { route: '/api/company/update', handler: _lazy_ALn4zC, lazy: true, middleware: false, method: "post" },
  { route: '/api/company/user/:id', handler: _lazy_fCK1to, lazy: true, middleware: false, method: "get" },
  { route: '/api/company/user/full/:id', handler: _lazy_6gpEKf, lazy: true, middleware: false, method: "get" },
  { route: '/api/login', handler: _lazy_PYXFHb, lazy: true, middleware: false, method: "post" },
  { route: '/api/register', handler: _lazy_BVWktj, lazy: true, middleware: false, method: "post" },
  { route: '/api/stateProgram/:id', handler: _lazy_6TfMNF, lazy: true, middleware: false, method: "get" },
  { route: '/api/stateProgram/addConditions', handler: _lazy_8fnUuk, lazy: true, middleware: false, method: "post" },
  { route: '/api/stateProgram/all', handler: _lazy_9c1ASD, lazy: true, middleware: false, method: "get" },
  { route: '/api/stateProgram/create', handler: _lazy_m33m01, lazy: true, middleware: false, method: "post" },
  { route: '/api/stateProgram/delete', handler: _lazy_t3E54W, lazy: true, middleware: false, method: "post" },
  { route: '/api/stateProgram/update', handler: _lazy_6AqCoD, lazy: true, middleware: false, method: "post" },
  { route: '/api/stateProgram/user/:id', handler: _lazy_uggxjB, lazy: true, middleware: false, method: "get" },
  { route: '/api/user/:id', handler: _lazy_AAYEoK, lazy: true, middleware: false, method: "get" },
  { route: '/api/user/edit', handler: _lazy_5nVHhz, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_P0jYr6, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_P0jYr6, lazy: true, middleware: false, method: undefined }
];
...
const combineConditionals_get = defineEventHandler(async (event) => {
  const companies = await prisma$k.company.findMany({
    where: {
      data: {
        not: Prisma.JsonNull
      }
  ...
  const conditions = await prisma$k.condition.findMany();
...
const combineConditionals_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: combineConditionals_get
});
...
const _id__get$a = defineEventHandler(async (event) => {
  ...
  const company = prisma$j.company.findFirst({ where: { id: Number(id) } });
  if (company === null) {
    throw createError({
      status: 404,
...
const addCondition_post = defineEventHandler(async (event) => {
  ...
  await prisma$i.company.findFirst({
    where: {
  ...
  const condition = await prisma$i.company.findFirst({
    where: {
      id: Number(body.companyId)
    }
  });
  ...
  await prisma$i.companyCondition.create({
    data: {
...
const addExtractData_post = defineEventHandler(async (event) => {
  const body = await readBody(event);
  if (!body.companyId) {
    throw createError({
      status: 400,
  ...
  const company = await prisma$h.company.findFirst({
    where: {
      id: body.companyId
    }
  });
  ...
  await prisma$h.company.update({ where: { id: body.companyId }, data: { data: body.data } });
  return company;
});

const addExtractData_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: addExtractData_post
});

const prisma$g = new PrismaClient();
const all_get$2 = defineEventHandler(async (event) => {
  const companies = prisma$g.company.findMany();
  return { companies };
});
...
const create_post$2 = defineEventHandler(async (event) => {
  const body = await readBody(event);
  const user = await prisma$f.user.findFirst({ where: { id: body.userId } });
  if (user === null) {
    throw createError({
      status: 404,
  ...
  const company = await prisma$f.company.create({
    data: {
      name: body.name,
...
const delete_post$2 = defineEventHandler(async (event) => {
  ...
  const { count } = await prisma$e.company.deleteMany({
    where: {
      id: {
        in: body.ids
      }
...
const update_post$2 = defineEventHandler(async (event) => {
  const body = await readBody(event);
  const user = await prisma$d.user.findFirst({ where: { id: body.userId } });
  if (user === null) {
    throw createError({
      status: 404,
      message: "\u041F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D"
  ...
  let company = await prisma$d.company.findFirst({ where: { id: body.id } });
  if (company === null) {
    throw createError({
      status: 404,
      message: "\u041F\u0440\u0435\u0434\u043F\u0440\u0438\u044F\u0442\u0438\u0435 \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u043E"
  ...
  await prisma$d.companyCondition.deleteMany({
    where: { companyId: body.id }
  });
  company = await prisma$d.company.update({
    where: {
      id: body.id
    },
    data: {
...
const update_post$3 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: update_post$2
});
...
const _id__get$8 = defineEventHandler(async (event) => {
  ...
  const user = await prisma$c.user.findFirst({ where: { id: Number(id) } });
  if (!user) {
    throw createError({
      status: 400,
      message: "\u041F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D"
  ...
  const companies = await prisma$c.company.findMany({
    include: {
      user: true
    },
...
const _id__get$6 = defineEventHandler(async (event) => {
  ...
  const user = await prisma$b.user.findFirst({ where: { id: Number(id) } });
  if (!user) {
    throw createError({
      status: 400,
      message: "\u041F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D"
  ...
  const userCompanies = await prisma$b.company.findMany({
    where: { userId: Number(id) },
    include: {
      conditions: {
        include: {
  ...
  const programs = await prisma$b.stateProgram.findMany({
    where: {
      status: "INDEXED",
      conditions: {
        some: {}
  ...
  for (const company of userCompanies) {
    ...
    for (const program of programs) {
      ...
      const matchingConditionIds = programConditionIds.filter(
        (id2) => companyConditionIds.includes(id2)
      );
      ...
      if (matchingConditionIds.length === programConditionIds.length) {
        ...
        partialCompliancePrograms.push({
          ...program,
          matchingConditions: program.conditions.filter(
            (cond) => matchingConditionIds.includes(cond.id)
          ),
          nonMatchingConditions: program.conditions.filter(
...
const alg = "HS256";
async function sing(payload) {
  const jwt = await new jose.SignJWT({ payload }).setProtectedHeader({ alg }).setExpirationTime("2h").sign(secret);
  return jwt;
}
...
const login_post = defineEventHandler(async (event) => {
  const body = await readBody(event);
  const user = await prisma$a.user.findUnique({
    where: {
      email: body.email
    }
  });
  ...
  const isSamePassword = compareSync(body.password, user.password);
  if (!isSamePassword) {
...
const register_post = defineEventHandler(async (event) => {
  ...
  let user = await prisma$9.user.findFirst({
    where: {
      email: body.email
    }
  });
  ...
  const newUser = await prisma$9.user.create({
    data: {
      email: body.email,
      password: hashPassowrd,
      name: body.name,
      surname: body.surname,
      patronymic: (_a = body.patronymic) != null ? _a : null
    }
  });
  if (newUser === null) {
    throw createError({
...
const _id__get$4 = defineEventHandler(async (event) => {
  ...
  const statePrograms = prisma$8.stateProgram.findFirst({
    where: { id: Number(id) }
  });
...
const addConditions_post = defineEventHandler(async (event) => {
  const body = await readBody(event);
  if (!body.programId) {
    throw createError({
      status: 402,
  ...
  const stateProg = await prisma$7.stateProgram.findFirst({
    where: {
  ...
  await prisma$7.stateProgram.update({ where: { id: stateProg.id }, data: { status: "INDEXED" } });
  const condition = await prisma$7.condition.createMany({ data: body.conditions.map((cond) => {
    return {
...
const addConditions_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: addConditions_post
});

const prisma$6 = new PrismaClient();
const all_get = defineEventHandler(async (event) => {
  const statePrograms = prisma$6.stateProgram.findMany({
    include: {
      conditions: true
    }
  });
...
const create_post = defineEventHandler(async (event) => {
  ...
  if (body.path) {
    ...
    state = await prisma$5.stateProgram.create({
      data: {
        name: body.name,
    ...
    const fileToSend = base64ToFile$1(
  ...
  if (body.conditions && state !== null) {
    for (const condition of body.conditions) {
      await prisma$5.condition.create({
        data: {
...
function base64ToFile$1(base64String, fileName, mimeType) {
...
const delete_post = defineEventHandler(async (event) => {
  ...
  const { count } = await prisma$4.stateProgram.deleteMany({
    where: {
      id: {
        in: body.ids
      }
...
const update_post = defineEventHandler(async (event) => {
  ...
  let state = null;
  const formData = new FormData();
  state = await prisma$3.stateProgram.update({
    where: {
      id: body.id
    },
    data: {
...
const _id__get$2 = defineEventHandler(async (event) => {
  ...
  const programs = await prisma$2.stateProgram.findMany({
    where: {
      status: "INDEXED",
      conditions: {
        some: {}
    ...
    for (const company of companies) {
      ...
      if (matchingConditionIds.length === programConditionIds.length) {
        ...
        partialComplianceCompanies.push({
          ...company,
          matchingConditions: company.conditions.filter(
            (cond) => matchingConditionIds.includes(cond.conditionId)
          ),
          nonMatchingConditions: program.conditions.filter(
            (cond) => nonMatchingConditionIds.includes(cond.id)
          )
...
const _id__get = defineEventHandler(async (event) => {
  ...
  const user = await prisma$1.user.findFirst({ where: { id: Number(id) } });
  if (user === null) {
    throw createError({
      status: 404,
      message: "\u041F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D"
...
const getClientManifest = () => import('file://G:/ProgramsSiteV2/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://G:/ProgramsSiteV2/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
