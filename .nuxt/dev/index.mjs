...
const _lazy_mZCP9W = () => Promise.resolve().then(function () { return _id__get$7; });
...
const _lazy_inrRNn = () => Promise.resolve().then(function () { return _id__get$5; });
...
const _lazy_AeNmaD = () => Promise.resolve().then(function () { return _id__get$3; });
